...
### What's Bad
No MS Store installed. I had to install it from the microsoft's website. If you are a gamer then be ready to install a lot of dependencies and <code>.dll</code> files. Apart from these things I have no complaints with this system whatsoever.
...
#### Links
- Download Windows LTSC: [https://massgrave.dev/windows_ltsc_links](https://massgrave.dev/windows_ltsc_links)
- Download Microsoft Store: [https://apps.microsoft.com/detail/9wzdncrfjbmp?hl=en-US&gl=IN](https://apps.microsoft.com/detail/9wzdncrfjbmp?hl=en-US&gl=IN)